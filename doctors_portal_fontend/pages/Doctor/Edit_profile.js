  ...
  <select id="Degree" name="Degree" required onChange={handleChangeDegree} value={degree}>
    ...
    <option value="other">Other</option>
      ...
      <div className="mb-4">
        ...
        <select id="Blood_group" name="Blood_group" required onChange={handleChangeBlood}>
  <option value="">Select Blood Group</option>
  <option value="A+" selected={Blood === "A+"}>A+</option>
  <option value="A-" selected={Blood === "A-"}>A-</option>
  <option value="B+" selected={Blood === "B+"}>B+</option>
  <option value="B-" selected={Blood === "B-"}>B-</option>
  <option value="AB+" selected={Blood === "AB+"}>AB+</option>
  <option value="AB-" selected={Blood === "AB-"}>AB-</option>
  <option value="O+" selected={Blood === "O+"}>O+</option>
  <option value="O-" selected={Blood === "O-"}>O-</option>
</select>

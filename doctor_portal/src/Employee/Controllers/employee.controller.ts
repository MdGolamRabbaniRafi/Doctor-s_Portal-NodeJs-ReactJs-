import { Body, Controller, Delete, Get, HttpException, HttpStatus, Param, ParseIntPipe, Post, Put, Session, UseGuards } from "@nestjs/common";
...
export class EmployeeController{
    ...
    @Put('/edit/:id')
    editEmployee(@Body() employee:EmployeeDto ,@Param('id',ParseIntPipe) id:number){
